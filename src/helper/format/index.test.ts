...
describe('Format functions', () => {
    describe('getClient', () => {
        it('should return the Regular string value', () => {
            expect(getClient('Regular: 16Mar2020(mon), 17Mar2020(tues), 18Mar2020(wed)')).toEqual('Regular')
        })
    ...
    describe('getDays', () => {
        it('should return array with 3 positions', () => {
            const result = getDays('Regular: 16Mar2020(mon), 17Mar2020(tues), 18Mar2020(wed)')
